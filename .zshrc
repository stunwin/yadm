...
if [[ -f ~/.config/.secrets/keys.env ]]; then
	source ~/.config/.secrets/keys.env
fi
...
plugins=(git copyfile copypath dirhistory zsh-autosuggestions zsh-syntax-highlighting)

source $ZSH/oh-my-zsh.sh

# User configuration
# disable ctrl+d end of file operation
setopt IGNORE_EOF
